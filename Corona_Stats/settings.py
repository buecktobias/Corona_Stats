"""
Django settings for Corona_Stats project.
...
SECRET_KEY = '$12$&q_@v@si23r_oh_5rf6^ngjeyha7p6#tclv*thy(q0!ek3'
...
ROOT_URLCONF = 'Corona_Stats.urls'
...
WSGI_APPLICATION = 'Corona_Stats.wsgi.application'
